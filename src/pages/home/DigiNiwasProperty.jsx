        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:6, marginBottom:10 }}>
          {[
            ...
            <div key={q.label} style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:4 }}>
              <div style={{ width:window.innerWidth < 768 ? 28 : 36,
height:window.innerWidth < 768 ? 28 : 36, borderRadius:7, border:"1px solid rgba(51,204,153,0.3)", display:"flex", alignItems:"center", justifyContent:"center", color:MINT }}>
        ...
        <div style={{ borderRadius:10, border:"1px solid #162a3a", background:"#071927", padding:10 }}>
          ...
          <div style={{ display:"flex", alignItems:"flex-end", gap:4, height: window.innerWidth < 768 ? 34 : 50 }}>
            {weekBars.map((h, i) => (
...
>
            ...
            <span style={{ color:MINT, letterSpacing:"0.18em", fontSize:12, fontWeight:600 }}>Partner DASHBOARD</span>
          </div>
